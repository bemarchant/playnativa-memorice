...
STATIC const mp_rom_map_elem_t audiodata__module_globals_table[] = {
...
STATIC MP_DEFINE_CONST_DICT(audiodata__module_globals, audiodata__module_globals_table);

const mp_obj_module_t audiodata__user_cmodule = {
    .base = { &mp_type_module },
    .globals = (mp_obj_dict_t*)&audiodata__module_globals,
};
